...
static const BYTE init_vals[][2] = {
	//{CYRF_MODE_OVERRIDE, 0x01}, //we have HW reset
...
static const BYTE bind_vals[][2] = {
    ...
    {CYRF_FRAMING_CFG,SOP_LEN|0xE}, //0x4A set sop len  32 chip and threshold =0xE 
    {CYRF_RX_OVERRIDE, DIS_RXCRC|FRC_RXDR}, //0x14 disable rx CRC Force Receive Data Rate
